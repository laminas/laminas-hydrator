...
class BooleanStrategyTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('Laminas\Hydrator\Strategy\BooleanStrategy', new BooleanStrategy(1, 0));
    }

    public function testConstructorWithValidString()
    {
        $this->assertInstanceOf('Laminas\Hydrator\Strategy\BooleanStrategy', new BooleanStrategy('true', 'false'));
    }
