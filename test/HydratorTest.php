...
class HydratorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testRetrieveWildStrategyAndOther()
    {
        ...
        $this->assertEquals(get_class($default), 'Laminas\Hydrator\Strategy\DefaultStrategy');
        $serializable = $hydrator->getStrategy('*');
        $this->assertEquals(get_class($serializable), 'Laminas\Hydrator\Strategy\SerializableStrategy');
    }
